  ...
  return (
    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-full mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
           <h2 className="text-2xl font-bold text-[#1c3068]">Daily Attendance</h2>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
        <div className="p-8">
           <h3 className="text-lg font-bold text-[#1c3068] mb-6">Filter Settings</h3>
           <div className="flex flex-col md:flex-row justify-between items-end gap-6">
             ...
             <div className="w-full md:w-auto">
               <button onClick={handleSubmit} disabled={loading || !selectedDate} className="w-full md:w-auto bg-[#1c3068] hover:bg-[#152450] text-white px-10 py-2.5 rounded-lg font-bold shadow-lg shadow-[#1c3068]/20 transition-all transform active:scale-95 disabled:opacity-50">
      ...
      {stats && (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col p-6 items-center justify-center">
            <Users size={32} className="text-[#1c3068] mb-2" />
            <p className="text-3xl font-bold text-[#1c3068]">{stats.total}</p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
        <div className="p-6 border-b border-gray-100">
           <p className="text-[#1c3068] font-bold text-lg capitalize">{activeTab} Attendance List</p>
        </div>
        ...
        <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full xl:w-auto">
              ...
              <div className="relative w-full sm:w-40">
                 <select 
                   ...
                   className="w-full pl-4 pr-10 py-2.5 border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-50 outline-none bg-gray-50 focus:bg-white transition-all appearance-none cursor-pointer text-[#1c3068] font-semibold"
                 >
              ...
              <div className="relative w-full sm:w-56">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-gray-50 focus:bg-white border border-gray-200 rounded-lg text-sm focus:border-[#1c3068] focus:ring-2 focus:ring-[#1c3068]/10 outline-none transition-all" 
                />
              </div>
            </div>
          </div>
          ...
          <div className="overflow-x-auto border border-gray-200 rounded-lg">
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {loading ? (
                  <tr><td colSpan={8} className="px-6 py-12 text-center text-gray-400 text-sm"><div className="flex justify-center"><div className="w-6 h-6 border-2 border-[#1c3068] border-t-transparent rounded-full animate-spin" /></div></td></tr>
                ) : !submitted ? (
    ...
    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-full mx-auto">
        ...
        <div className="p-8">
           <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
             ...
             <div className="bg-gray-50 p-1 rounded-lg border border-gray-200 flex">
               <button onClick={() => setViewType('date')} className={`px-5 py-2 rounded-md text-sm font-semibold transition-all ${viewType === 'date' ? 'bg-white text-[#1c3068] shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}>By Date</button>
               <button onClick={() => setViewType('month')} className={`px-5 py-2 rounded-md text-sm font-semibold transition-all ${viewType === 'month' ? 'bg-white text-[#1c3068] shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}>By Month</button>
             </div>
           </div>
           ...
           <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
             ...
             <div className="mt-4 md:mt-0 md:ml-auto self-end md:self-center pt-6">
               <button onClick={handleSubmit} disabled={loading || (viewType === 'month' ? !selectedMonth : !selectedDate)} className="bg-[#1c3068] hover:bg-[#152450] text-white px-8 py-2.5 rounded-lg font-bold shadow-lg shadow-[#1c3068]/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 min-w-[120px]">
      ...
      { viewType !== 'month' && (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col p-6 items-center justify-center">
            <Users size={32} className="text-[#1c3068] mb-2" />
            <p className="text-3xl font-bold text-[#1c3068]">{total}</p>
            <p className="text-xs text-gray-500 uppercase tracking-wider font-bold">Total Expected</p>
          </div>
          <div className="bg-[#1c3068] rounded-xl shadow-sm p-6 flex flex-col items-center justify-center text-white">
                ...
                <div className="w-full h-full" style={{ minHeight: '300px' }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={displayData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                      ...
                      <Line type="monotone" dataKey="present" stroke="#1c3068" strokeWidth={3} dot={{ r: 4, fill: '#1c3068' }} name="Present & Late" />
        ...
        <div className="p-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <input type="text" value={search} onChange={e => { setSearch(e.target.value); setCurrentPage(1); }} className="w-full sm:w-48 px-3 py-1.5 bg-gray-50 border border-gray-200 rounded text-sm focus:border-[#1c3068] focus:bg-white focus:ring-2 outline-none transition-all" />
            </div>
          </div>
...
const SummaryReport = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-full mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
        <div className="p-8">
           <h3 className="text-lg font-bold text-[#1c3068] mb-6">Report Date</h3>
           <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
             <div className="w-full md:w-64 space-y-2">
               <label className="block text-sm font-bold text-[#1c3068]"><span className="text-[#c53336] mr-1">*</span> Date</label>
               <input type="date" value={selectedDate} onChange={(e) => setSelectedDate(e.target.value)} className="w-full px-4 py-2.5 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#1c3068] outline-none transition-all text-gray-700" />
             ...
             <div className="mt-4 md:mt-0 md:ml-auto self-end md:self-center pt-6">
               <button onClick={handleSubmit} disabled={loading || !selectedDate} className="bg-[#1c3068] hover:bg-[#152450] text-white px-8 py-2.5 rounded-lg font-bold shadow-lg shadow-[#1c3068]/20 transition-all disabled:opacity-50 min-w-[120px]">
                 {loading ? 'Loading...' : 'Generate'}
               </button>
             </div>
           </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <span className="text-sm text-gray-500">Search:</span>
              <input type="text" value={search} onChange={e => { setSearch(e.target.value); setCurrentPage(1); }} className="w-full sm:w-48 px-3 py-1.5 bg-gray-50 border border-gray-200 focus:bg-white rounded text-sm focus:border-[#1c3068] outline-none transition-all" />
            </div>
          </div>
