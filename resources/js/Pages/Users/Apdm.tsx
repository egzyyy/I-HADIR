    ...
    >
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-8 border-b border-gray-100 bg-gray-50/50">
          <h2 className="text-2xl font-bold text-role">Import APDM Data</h2>
        ...
        <div className="p-8 space-y-8">
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-role">Format Requirement:</h3>
          ...
          <div className="max-w-md space-y-2">
            ...
            <div className="relative">
              <select 
                ...
                className="w-full px-4 py-3 rounded-xl bg-white border border-gray-200 focus:border-role focus:ring-2 focus:ring-role/10 outline-none transition-all appearance-none text-gray-700 cursor-pointer"
              >
            ...
            {selectedClassId && (
              ...
              >
                <div className="pt-8 border-t border-gray-100">
                  <h3 className="text-lg font-bold text-role mb-4">Upload CSV File</h3>
                  ...
                  <label className="w-full h-64 border-2 border-dashed border-gray-200 rounded-xl flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer group relative">
                    ...
                    <div className="flex items-center gap-2 text-role font-semibold">
                      <Upload size={18} />
