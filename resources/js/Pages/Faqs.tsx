  ...
  return (
    ...
    >
      <div className="text-center mb-10">
        <h2 className="text-3xl font-black text-[#1c3068] mb-4">Frequently Asked Questions</h2>
      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            >
              <span className={`text-lg font-bold transition-colors ${openIndex === index ? 'text-[#1c3068]' : 'text-gray-700'}`}>
                {faq.question}
              </span>
