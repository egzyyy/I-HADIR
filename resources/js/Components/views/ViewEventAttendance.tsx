                ...
                <div className="p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gray-50/30">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="relative w-full sm:w-64">
                            ...
                            <input type="text" placeholder="Search name or IC..." value={search} onChange={(e) => setSearch(e.target.value)} className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:border-[#1c3068] outline-none transition-all" />
                        </div>
                    </div>
                </div>
                            ...
                            {loading ? (
                                ...
                                filteredAttendees.map((a, index) => (
                                    <tr key={a.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-sm font-bold text-[#1c3068]">{a.name}</td>
