...
export const UserInfoModal = ({ isOpen, onClose, user }: UserInfoModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        {/* Header Background */}
        <div className="h-32 bg-gradient-to-r from-[#1c3068] to-[#2a4595] w-full absolute top-0 left-0 z-0"></div>

        <div className="relative z-10 px-8 pb-8 pt-16 flex flex-col h-full overflow-y-auto">
            {/* Profile Section */}
