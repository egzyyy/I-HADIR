    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        ...
        <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
          <div>
            <h3 className="text-xl font-bold text-role">Edit class</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white focus:border-role focus:ring-2 focus:ring-role/10 outline-none transition-all font-medium text-role"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white focus:border-role focus:ring-2 focus:ring-role/10 outline-none transition-all appearance-none text-role font-medium cursor-pointer uppercase"
                  >
